    ...
    return (
        <>
            ...
            <div className="footer__logos">
                ...
                <a href="https://www.zurich.com/en/sustainability/investing-in-communities/z-zurich-foundation" target="_blank">
                    <img
            ...
            <div className="footer__contact">
                <a href="http://www.globalresiliencepartnership.org/privacy/" target="_blank">Privacy Policy</a>

                <a href="mailto:info@globalresiliencepartnership.org" target="_blank">info@globalresiliencepartnership.org</a>
            </div>
        </>
    )
}
